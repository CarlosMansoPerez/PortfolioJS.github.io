document.getElementById('Function').addEventListener("click",myFunction);
    ...
    if (!isNaN(z) && z%1==0 && z>=1){  
        ...
        document.getElementById("calculo2").style.color="red";  
